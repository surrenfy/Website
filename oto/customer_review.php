<?php
    ...
    if (mysqli_connect_errno()) {
        ...
        $query = 'select * from orders where customer_email = "'.$email.'" and status_id >= 4 order by overtime desc';
...
<body>
      <div class="ui inverted fixed bottom sticky menu" style="text-align:center" id="menu">
        ...
        <a class="item active" style="width:25%;padding-bottom:2px;padding-top:2px" href = "./customer_review.php">
           <div class="statistic" style="margin:0 auto">
            <div class="value">
  ...
  <body>
    <div class="ui container">
        <div class="ui secondary pointing center aligned menu">
          ...
          <a class="item active" href = "./customer_review.php">Review</a>
  ...
  <div class="item">
    ...
    <div class="label">
      ...
      <div class="extra">';
        ...
        echo '<label class="ui red large label"><i class="ban icon"></i>Canceled</label>';
       echo '</div>
      </div>
    </div>'; 
      }
