                    ...
                    <div class="row row-rl-10 row-tb-20">
                        ...
                        <div class="page-content col-xs-12 col-sm-8 col-md-9">
                            ...
                            <section class="section checkout-area panel prl-30 pt-20 pb-40">
                                <h2 class="h2 mb-20 h-title">Transaction Record</h2>
                                <form class="mb-30">
                                    <div class="row">
										<div class="col-md-12">
                                            
											<table id="#"  class="wishlist mb-20" CellSpacing=2 border='1' frame="hsides" style="word-break:break-all; word-wrap:break-all;" >
												<thead class="panel font-14">
													<tr >
														<th>Commodity</th>	
														<th>Unit price</th>
														<th>Subtotal</th>
													...
													<tr class="panel alert">
														<td colspan="5" style="padding:3px 10px;color:black">
															<label><div class="choose_1 ml-5">2017-5-23</div></label>
														...
														<tr class="panel alert">
																...
																<td class="col-sm-5 col-md-4">
																	<div class="media-body valign-middle">
																		<h6 class="title mb-15 t-uppercase"><a href="#">Diamond engagement ringxxxxxxxxxxxx</a></h6>
																		<div class="type font-12"><span class="t-uppercase">size : </span>L</div>
																		<div class="type font-12"><span class="t-uppercase">color : </span>black</div>
																	</div>	
																</td>
																...
																<td class="col-sm-3 col-md-2"style="text-align:center">
																	<div class="type font-12"><span class="t-uppercase">1</span></div>	
																</td>
																<td class="col-sm-3 col-md-2"style="text-align:center">
																	<div class="media-body valign-middle">
																		<div class="type font-14 mb-10"><span class="t-uppercase">$240 </span></div>
																		<div class="type font-12"><span>(freight  : </span>$10)</div>
																		<div class="type font-12"><span>(discount : </span>$5)</div>
																	</div>	
																</td>
														</tr>
													</tbody>
