<?php
    ...
    if (mysqli_connect_errno()){
        ...
        $query = 'select * from progress where customer_email = "'.$email.'" and agreed = 2  and remove = 0 order by status desc,payed desc';
        $result = $mysqli->query ($query);
        $modals = array();
    }
?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <ul class="nav-top nav-top-right list-inline t-xs-center t-md-right">
                                ...
                                ?>
							  <li><a href="chinese-message.php" style="font-family:'微软雅黑'"><i class="fa fa-paperclip"></i><b>中文</b></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <section class="wishlist-area ptb-30">
                        <div class="container">
                            <div class="wishlist-wrapper">
								...
								<nav>
									<ul> 
									<li><a href="message.php"style="margin-right:20px;color:#5cb85b;font-size:1.3em"><b>I Agreed</b></a></li> 
									<li><a href="message_new.php"style="margin-right:20px;color:#f0ad4e;font-size:1em"><b>New</b></a></li> 
                                ...
                                <?php 
                                    $first = 1;
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row row-v-10">
                                                                <div class="col-md-10 col-md-offset-1">
                                                                    ...
                                                                    <h3 class="mb-20" style="text-align:left">The add-on item is accepted by all customers </h3>
                                                                </div>
                                        ...
                                        else $modal = '<div class="modal fade get-coupon-area" tabindex="-1" role="dialog" id="'.$id.$addr_id.$product_id.'">
                                    <div class="modal-dialog">
                                        <div class="modal-content panel">
                                            <div class="modal-body">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                                        ...
                                        echo '</tr></tbody></table>';        
                                            $save = round($original*$off/$total,2);
                                                        ...
                                                        $modal = $modal.'<div class="col-md-10 col-md-offset-1">
                                                                    <p class="color-mid mb-20" style="font-size:1.1em;margin-top:20px;text-align:right">if you go to payment,you will save <b style="font-size:1.2em; color: #F07818">'.$save.'</b> yuan </p>
                                                                        <form method="post">
                                                                            ...
                                                                            <button class="btn" type="submit" formaction="progress_update.php?func=pay" style="height:30px;padding:4px;width:80px;float:right;margin-top:30px">PAYMENT</button>
                                                                            <button id="disagree_'.$id.'" class="btn" type="submit" formaction="progress_update.php?func=cancel" style="display:none"></button>
                                                                        </form>
                                                                    <div class="widget-body pt-30 pb-20"style="float:right">
                                                                        <div class="tags">
                                                                            <a class="badge" onclick=\'$("#disagree_'.$id.'").click();\'>CANCEL</a>
                                                                        </div>
                                                                    </div>
                                                                </div> 
                                                            </div>
                                                        ...
                                                        $modal = $modal.'<div class="col-md-10 col-md-offset-1">
                                                                    <p class="color-mid mb-20" style="font-size:1.1em;margin-top:20px;text-align:right">You have payed and will save <b style="font-size:1.2em; color: #F07818">'.$save.'</b> yuan </p>
                                                                        <form method="post">
                                                                            <input style="display:none" type="text" name ="id" value="'.$id.'"/>
                                                                            <input style="display:none" type="text" name ="product_id" value="'.$product_id.'"/>
                                                                            <input style="display:none" type="text" name ="addr_id" value="'.$addr_id.'"/>
                                                                            <button class="btn" data-dismiss="modal" style="height:30px;padding:4px;width:80px;float:right;margin-top:30px">OK</button>
                                                                            <button id="disagree_'.$id.'" class="btn" type="submit" formaction="progress_update.php?func=cancel" style="display:none"></button>
                                                                        </form>
                                                                    <div class="widget-body pt-30 pb-20"style="float:right">
                                                                        <div class="tags">
                                ...
                                else $modal = $modal.'<div class="col-md-10 col-md-offset-1">  
														<form method="post">
                                                            <input style="display:none" type="text" name ="id" value="'.$id.'"/>
                                                            <input style="display:none" type="text" name ="product_id" value="'.$product_id.'"/>
                                                            <input style="display:none" type="text" name ="addr_id" value="'.$addr_id.'"/>
                                                            <button class="btn" type="submit" formaction="progress_update.php?func=remove" style="height:30px;padding:4px;width:80px;float:right;margin-top:30px">REMOVE</button>
                                                        </form>
                                                    </div> 
                                                </div>
                                            </div>
                            ...
                            $modals[]= $modal;  
                            if ($status=="2")
								 echo '<button class="btn btn-rounded btn-sm mt-15 mb-15" data-toggle="modal" data-target="#'.$id.$addr_id.$product_id.'" style="float:right">Go to Payment</button>';
                            else  echo '<button class="btn btn-rounded btn-sm mt-15 mb-15" data-toggle="modal" data-target="#'.$id.$addr_id.$product_id.'" style="float:right">Show more details</button>';
            }
