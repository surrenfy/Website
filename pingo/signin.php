<?php
  ...
  $password = "";
  $flag=0;
  if (!empty($_GET['flag']) && $_GET['flag']=="1")
  {
    $flag=1;
  }
    ...
    if (mysqli_connect_errno()){
      ...
      if ($result->num_rows) {
        ...
        if (!empty($_POST['remember']))
          setcookie("customer_email", $email, time()+60);
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-8">
              <ul class="nav-top nav-top-right list-inline t-xs-center t-md-right">
                ...
                <li><a href="chinese-signin.php" style="font-family:'微软雅黑'"><i class="fa fa-paperclip"></i><b>中文</b></a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="container" style="width:450px;text-align:center">
            <section class="panel p-40">
              <h3 class="sign-title" style="text-align:center">Log In <small>Or <a href="signup.php" class="color-green"> Sign Up</a></small></h3>
              <hr style="width:70%">
              <div class="row">
                <form class="" action="./signin.php" method="post">
                  <?php
                  if ($flag==2)
                  echo '<div class="alert alert-warning" id="alert" role="alert" style="display:block;height:45px;padding-top:8px">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    Wrong password or unsigned email
                  </div>';
                  elseif ($flag==1)
                  echo '<div class="alert alert-warning" id="alert" role="alert" style="display:block;height:45px;padding-top:8px">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    We have lost your info, please relog-in
                  </div>'
                  ?>
                  <div class="form-group">
                    <label class="sr-only">Email</label>
                      <input type="email" name="email" class="form-control input-lg" placeholder="Email" maxlength="32" autofocus required>
                  </div>
                  <div class="form-group">
                    <label class="sr-only">Password</label>
                    <input type="password" name="password" class="form-control input-lg" placeholder="Password" maxlength="32" required>
                  </div>
                  <div class="form-group">
                    <span class="color-mid"><a href="./signup.php" class="color-green">Create Account | </a><a href="#" class="forgot-pass-link">Forget My Password</a>
                            </div>
                                <!-- <div class="text-center color-mid">Need an Account ? <a href="signup.html" class="color-green">Create Account</a></div> -->
                            <div class="custom-checkbox mb-20" style="margin-left:10px;text-align:left">
                                <input name="remember" type="checkbox" id="remember_account" checked>
